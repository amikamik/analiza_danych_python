...
// Upewnij się, że ten adres jest poprawny dla Twojego środowiska
    ...
    <div style={styles.container}>
      ...
      <section style={styles.keyInfoSection}>
        <div style={styles.keyInfoCard}>
          ...
          <p>Prześlij swoje dane w pliku <strong>.CSV</strong> z kodowaniem <strong>UTF-8</strong>.</p>
        </div>
        <div style={styles.keyInfoCard}>
...
const styles = {
  ...
  keyInfoSection: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px', marginBottom: '40px', textAlign: 'center' },
  keyInfoCard: { backgroundColor: '#ecf0f1', padding: '20px', borderRadius: '8px' },
  clickableCard: { cursor: 'pointer', backgroundColor: '#e0e6e8', transition: 'transform 0.2s', ':hover': { transform: 'scale(1.02)' } },
